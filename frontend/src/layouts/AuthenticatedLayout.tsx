...
export default function AuthenticatedLayout() {
    ...
    const isFullBleed = isProgramDetail || isResidentProfile || isResidentsPage || isClassDetail || isEventAttendance || isClassesPage || isDashboard || isProgramsList || isFacilities || isAdmins || isKnowledgeCenter || isContentViewer || isResidentPage || isSchedule || isMyTranscript;
    const fullBleedWrapperClass =
        isDashboard || isProgramsList || isFacilities || isAdmins || isProgramDetail || isResidentProfile || isResidentsPage || isClassDetail || isClassesPage || isKnowledgeCenter || isContentViewer || isResidentPage || isSchedule || isMyTranscript ? 'py-0' : 'py-4';
