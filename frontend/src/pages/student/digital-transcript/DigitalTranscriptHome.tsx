                            ...
                            <CardDescription className="text-base leading-relaxed">
                                {hasDraft ? (
                                    <>
                                        ...
                                        add a new program achievement.
                                    </>
                                ) : entries.length === 0 ? (
                                    <>
                                        Open the editor and fill in what you did. Nothing appears on this list
                                        until you tap Done.
                                    </>
                                ) : (
                                    <>
                                        You have saved {entries.length}{' '}
                                        {entries.length === 1 ? 'achievement' : 'achievements'}. Add another
                                        anytime.
                                    </>
                                )}
                            </CardDescription>
                                ...
                                <>
                                    {entries.length > 0 && (
                                        <>
                                            ...
                                            <Button asChild variant="secondary" size="lg" className="sm:min-w-[8rem]">
                                                <Link to={entryPath}>Edit</Link>
                                            </Button>
                                        </>
                                    )}
            ...
            <section className="flex min-h-0 flex-col">
                ...
                {entries.length === 0 ? (
                    <EmptyState
                        ...
                        description="When you finish editing and tap Done, your achievement appears here."
                    />
                ) : (
                    <Card
                                    ...
                                    {entriesNewestFirst.map((entry) => (
                                        ...
                                        >
                                            <TableCell className="max-w-[14rem] pl-6 align-top font-medium text-foreground">
                                                <div className="font-medium">{entry.programName.trim() || '—'}</div>
                                            ...
                                            <TableCell className="align-top pr-6 text-right">
                                                <Button variant="outline" size="sm" className="shrink-0" asChild>
                                                    <Link to={`${entryPath}?edit=${encodeURIComponent(entry.id)}`}>
                                                        Edit
                                                    </Link>
                                                </Button>
                                            </TableCell>
